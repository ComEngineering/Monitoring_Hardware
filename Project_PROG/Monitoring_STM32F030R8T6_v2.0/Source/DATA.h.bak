...
//***************************************************************************
#define PIN_ONE_WIRE_T1				GPIOB, GPIO_Pin_10		//пин датчика Dt1
#define PIN_ONE_WIRE_T2				GPIOB, GPIO_Pin_11		//пин датчика Dt2
#define PIN_ONE_WIRE_T3				GPIOF, GPIO_Pin_4			//пин датчика Dt3
#define PIN_ONE_WIRE_T4				GPIOF, GPIO_Pin_5			//пин датчика Dt4


#define PIN_OVERLOAD_12V 			GPIOA, GPIO_Pin_0			//пин детектора перегрузки по выходному внешнему питанию 12В 400 мА


#define PIN_DIN1 							GPIOC, GPIO_Pin_5			//пин дискретного сигнального входа 1
#define PIN_DIN2 							GPIOB, GPIO_Pin_0			//пин дискретного сигнального входа 2
#define PIN_DIN3 							GPIOB, GPIO_Pin_1			//пин дискретного сигнального входа 3
#define PIN_DIN4 							GPIOB, GPIO_Pin_2			//пин дискретного сигнального входа 4
#define PIN_DIN5 							GPIOA, GPIO_Pin_5			//пин дискретного сигнального входа 5
#define PIN_DIN6 							GPIOA, GPIO_Pin_6			//пин дискретного сигнального входа 6
#define PIN_DIN7 							GPIOA, GPIO_Pin_7			//пин дискретного сигнального входа 7
#define PIN_DIN8 							GPIOC, GPIO_Pin_4			//пин дискретного сигнального входа 8


#define PIN_DCIN1 						GPIOB, GPIO_Pin_13		//пин входа сухого контата 1
#define PIN_DCIN2 						GPIOB, GPIO_Pin_14		//пин входа сухого контата 2
#define PIN_DCIN3 						GPIOB, GPIO_Pin_15		//пин входа сухого контата 3
#define PIN_DCIN4 						GPIOC, GPIO_Pin_6			//пин входа сухого контата 4
#define PIN_DCIN5 						GPIOC, GPIO_Pin_7			//пин входа сухого контата 5
#define PIN_DCIN6 						GPIOC, GPIO_Pin_8			//пин входа сухого контата 6
#define PIN_DCIN7 						GPIOC, GPIO_Pin_9			//пин входа сухого контата 7
#define PIN_DCIN8 						GPIOA, GPIO_Pin_8			//пин входа сухого контата 8
...
#define STATE_DISCON_DT3 			0x80												/*!< обрыв Dt3 (0–ok, 1–обрыв) */
#define STATE_CIRCUIT_DT3 		0x100												/*!< замыкание Dt3 (0–ok, 1–кз) */
#define STATE_CRC_ERR_DT3 		0x200												/*!< ошибка CRC Dt3 (0–ok, 1–err) */
#define STATE_DISCON_DT4 			0x400												/*!< обрыв Dt4 (0–ok, 1–обрыв) */
#define STATE_CIRCUIT_DT4 		0x800												/*!< замыкание Dt4 (0–ok, 1–кз) */
#define STATE_CRC_ERR_DT4 		0x1000											/*!< ошибка CRC Dt4 (0–ok, 1–err) */
...
#define ALL_STATE_DT3 				STATE_DISCON_DT3 | STATE_CIRCUIT_DT3 | STATE_CRC_ERR_DT3
#define ALL_STATE_DT4 				STATE_DISCON_DT4 | STATE_CIRCUIT_DT4 | STATE_CRC_ERR_DT4

#define R_DT1							res_table.regsF3_6[1]						/*!< значение температуры Dt1 */
#define R_DT2							res_table.regsF3_6[2]						/*!< значение температуры Dt2 */
#define R_DT3			 				res_table.regsF3_6[3]						/*!< значение температуры Dt3 */
#define R_DT4			 				res_table.regsF3_6[4]						/*!< значение температуры Dt4 */
